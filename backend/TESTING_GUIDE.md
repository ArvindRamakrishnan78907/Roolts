...
```powershell
curl http://localhost:5000/api/virtual-env/environments ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X POST http://localhost:5000/api/virtual-env/environments/1/start ^
  -H "X-User-ID: 1"
```
...
```powershell
curl http://localhost:5000/api/virtual-env/environments/1/logs ^
  -H "X-User-ID: 1"
```
...
```powershell
curl "http://localhost:5000/api/virtual-env/environments/1/packages?manager=npm" ^
  -H "X-User-ID: 1"
```
...
```powershell
curl "http://localhost:5000/api/virtual-env/environments/1/files?path=/workspace" ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X PUT http://localhost:5000/api/virtual-env/environments/1/files/app.js ^
  -H "Content-Type: application/json" ^
  -H "X-User-ID: 1" ^
...
```powershell
curl http://localhost:5000/api/virtual-env/environments/1/files/app.js ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X POST http://localhost:5000/api/virtual-env/environments/1/mkdir ^
  -H "Content-Type: application/json" ^
  -H "X-User-ID: 1" ^
...
```powershell
curl -X DELETE http://localhost:5000/api/virtual-env/environments/1/files/app.js ^
  -H "X-User-ID: 1"
```
...
```powershell
curl http://localhost:5000/api/virtual-env/environments/1 ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X POST http://localhost:5000/api/virtual-env/environments/1/stop ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X POST http://localhost:5000/api/virtual-env/environments/2/start ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X POST http://localhost:5000/api/virtual-env/environments/2/execute ^
  -H "Content-Type: application/json" ^
  -H "X-User-ID: 1" ^
...
```powershell
curl -X DELETE http://localhost:5000/api/virtual-env/environments/2 ^
  -H "X-User-ID: 1"
```
...
```powershell
curl -X DELETE http://localhost:5000/api/virtual-env/environments/1 ^
  -H "X-User-ID: 1"
```
