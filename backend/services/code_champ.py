...
class CodeChampService:
    ...
    async def analyze_code(self, code: str, language: str = "python") -> Dict[str, Any]:
        """
        Analyze code for bugs, quality issues, and improvements.
        """
        start_time = time.time()
        
        system_prompt = (
            "You are CodeChamp, an elite automated code reviewer. "
            "Analyze the provided code for bugs, performance issues, and code quality. "
        ...
        # Check Cache
        cache_key = response_cache._generate_key("analyze", code, language)
