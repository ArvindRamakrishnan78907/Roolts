...
**PowerShell:**
```powershell
Invoke-RestMethod -Uri "http://localhost:5000/api/virtual-env/environments" -Method POST -Headers @{"Content-Type"="application/json"; "X-User-ID"="1"} -Body '{"name": "my-first-env", "type": "nodejs"}'
```
...
curl -X POST http://localhost:5000/api/virtual-env/environments/1/start -H "X-User-ID: 1"

# Run a command
curl -X POST http://localhost:5000/api/virtual-env/environments/1/execute -H "Content-Type: application/json" -H "X-User-ID: 1" -d "{\"command\": \"node --version\"}"
```
...
Invoke-RestMethod -Uri "http://localhost:5000/api/virtual-env/environments" -Method POST -Headers @{"Content-Type"="application/json"; "X-User-ID"="1"} -Body '{"name": "test", "type": "nodejs"}'
...
# 5. Create file
Invoke-RestMethod -Uri "http://localhost:5000/api/virtual-env/environments/1/files/app.js" -Method PUT -Headers @{"Content-Type"="application/json"; "X-User-ID"="1"} -Body '{"content": "console.log(\"Hello\");"}'
