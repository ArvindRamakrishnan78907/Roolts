...
app.listen(PORT, () => {
    console.log(`🚀 Roolts Code Executor running on http://localhost:${PORT}`);
    console.log(`   Health: http://localhost:${PORT}/api/executor/health`);
    console.log(`   Languages: http://localhost:${PORT}/api/executor/languages`);
});
